...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/VI.2.a.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/VI.2.b.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/VI.2.c.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/VI.2.png}
...
\begin{lstlisting}
gcc -shared -o VI.3.so -fPIC VI.3.c
\end{lstlisting}
